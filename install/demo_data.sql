...
('marie.dupont@email.com', '$2y$12$suQWNoZou3uFyl7NCdecaejQdZAn.a6y0sNGqkazUTXLoIy06fY22', 'Dupont', 'Marie', 'membre', '06 12 34 56 78', '15 rue de la Paix', 'Paris', '75001', 'France', 'Française', 'Français, Anglais', '2020-03-15', '1985-06-20', 'Enseignante', 'Membre très active, participe à tous les événements', 1, '2023-01-15 10:00:00'),
('jean.martin@email.com', '$2y$12$suQWNoZou3uFyl7NCdecaejQdZAn.a6y0sNGqkazUTXLoIy06fY22', 'Martin', 'Jean', 'membre', '06 23 45 67 89', '8 avenue des Champs', 'Lyon', '69001', 'Belgique', 'Belge', 'Français, Néerlandais', '2019-09-01', '1978-11-03', 'Ingénieur', 'A proposé d''organiser un atelier informatique', 1, '2023-02-20 14:30:00'),
('sophie.bernard@email.com', '$2y$12$suQWNoZou3uFyl7NCdecaejQdZAn.a6y0sNGqkazUTXLoIy06fY22', 'Bernard', 'Sophie', 'gestionnaire', '06 34 56 78 90', '22 boulevard Victor Hugo', 'Marseille', '13001', 'Suisse', 'Suisse', 'Français, Allemand', '2018-05-10', '1990-02-14', 'Comptable', 'Gestionnaire bénévole depuis 2023', 1, '2023-03-10 09:15:00'),
('pierre.leroy@email.com', '$2y$12$suQWNoZou3uFyl7NCdecaejQdZAn.a6y0sNGqkazUTXLoIy06fY22', 'Leroy', 'Pierre', 'membre', '06 45 67 89 01', '5 place de la République', 'Toulouse', '31000', 'Canada', 'Canadien', 'Français, Anglais', '2021-01-20', '1995-08-25', 'Étudiant', 'Étudiant en échange universitaire', 1, '2023-04-05 11:45:00'),
('isabelle.moreau@email.com', '$2y$12$suQWNoZou3uFyl7NCdecaejQdZAn.a6y0sNGqkazUTXLoIy06fY22', 'Moreau', 'Isabelle', 'membre', '06 56 78 90 12', '18 rue du Commerce', 'Bordeaux', '33000', 'France', 'Française', 'Français', '2022-06-30', '1970-04-18', 'Médecin', 'Peut aider pour les questions de santé', 1, '2023-05-12 16:20:00'),
('lucas.petit@email.com', '$2y$12$suQWNoZou3uFyl7NCdecaejQdZAn.a6y0sNGqkazUTXLoIy06fY22', 'Petit', 'Lucas', 'membre', '06 67 89 01 23', '30 rue de Rivoli', 'Nice', '06000', 'Luxembourg', 'Luxembourgeois', 'Français, Allemand, Luxembourgeois', '2020-11-05', '1988-12-30', 'Avocat', '', 1, '2023-06-18 13:00:00'),
('emma.roux@email.com', '$2y$12$suQWNoZou3uFyl7NCdecaejQdZAn.a6y0sNGqkazUTXLoIy06fY22', 'Roux', 'Emma', 'membre', '06 78 90 12 34', '12 avenue Foch', 'Strasbourg', '67000', 'Sénégal', 'Sénégalaise', 'Français, Wolof', '2019-03-22', '1992-07-08', 'Infirmière', 'Très impliquée dans les actions sociales', 1, '2023-07-22 10:30:00'),
('antoine.girard@email.com', '$2y$12$suQWNoZou3uFyl7NCdecaejQdZAn.a6y0sNGqkazUTXLoIy06fY22', 'Girard', 'Antoine', 'membre', '06 89 01 23 45', '7 rue Pasteur', 'Nantes', '44000', 'Maroc', 'Marocain', 'Français, Arabe', '2021-08-14', '1983-01-12', 'Chef cuisinier', 'A proposé de faire la cuisine pour les événements', 1, '2023-08-30 15:45:00'),
('claire.lambert@email.com', '$2y$12$suQWNoZou3uFyl7NCdecaejQdZAn.a6y0sNGqkazUTXLoIy06fY22', 'Lambert', 'Claire', 'membre', '06 90 12 34 56', '25 rue de la Liberté', 'Lille', '59000', 'Côte d''Ivoire', 'Ivoirienne', 'Français', '2022-02-28', '1998-09-05', 'Étudiante', 'Nouvelle membre, cherche à s''intégrer', 1, '2023-09-14 09:00:00'),
('thomas.dubois@email.com', '$2y$12$suQWNoZou3uFyl7NCdecaejQdZAn.a6y0sNGqkazUTXLoIy06fY22', 'Dubois', 'Thomas', 'membre', '06 01 23 45 67', '40 boulevard Haussmann', 'Paris', '75009', 'Haïti', 'Haïtien', 'Français, Créole', '2020-07-19', '1975-05-22', 'Musicien', 'Peut animer les soirées musicales', 1, '2023-10-20 14:15:00');
